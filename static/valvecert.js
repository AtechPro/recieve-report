// JS for Valve Certificate Interactive Form
...
function getPretestData() {
    return {
        ...
        seat: {
            pressure: document.getElementById('pretest_seat_pressure').value,
            duration: document.getElementById('pretest_seat_duration').value,
            result_remarks: document.getElementById('pretest_seat_result').value
        },
...
function getPosttestData() {
    return {
        ...
        seat: {
            pressure: document.getElementById('posttest_seat_pressure').value,
            duration: document.getElementById('posttest_seat_duration').value,
            result_remarks: document.getElementById('posttest_seat_result').value
        },
